...
using TaiShop.Data;
using TaiShop.Models;
using TaiShop.Services;
using TaiShop.Data.EF;
using TaiShop.Data.Entities;
using AutoMapper;
using TaiShop.Service.Implementation;
using TaiShop.Service.Interfaces;
using TaiShop.Data.IRepositories;
using TaiShop.Data.EF.Repositories;
using Microsoft.Extensions.Logging;
using Newtonsoft.Json.Serialization;
using TaiShop.Helpers;
using TaiShop.Infrastructure.Interfaces;
using Microsoft.AspNetCore.Authorization;
using TaiShop.Authorization;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<AppDbContext>(options =>
                ...
                o => o.MigrationsAssembly("TaiShop.Data.EF")
                ));
        ...
        {
            loggerFactory.AddFile("Logs/main-{Date}.txt");
